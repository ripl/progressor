...
<Header
  ...
  links={[
    {
      name: "Paper",
      url: "https://openaccess.thecvf.com/content/ICCV2025/papers/Ayalew_PROGRESSOR_A_Perceptually_Guided_Reward_Estimator_with_Self-Supervised_Online_Refinement_ICCV_2025_paper.pdf",
    ...
    {
      name: "Dataset",
      url: "https://huggingface.co/datasets/tedywond/metaworld_expert_demonstrations",
      icon: "fa-solid:database",
    },
    {
      name: "Weight",
      url: "https://huggingface.co/tedywond/PROGRESSOR-pretrained-weight/blob/main/PROGRESSOR_EPIC_KITCHENS_pretrained_weight.pth",
...
<Figure caption="Visualization of the robotic tasks: (a-d) Real world environments with a UR5 arm. (e-j) Simulation environments for evaluation using the Meta-World benchmark.">
    
    <Image source={expfig} altText="Visualization of the robotic tasks" />
</Figure>
