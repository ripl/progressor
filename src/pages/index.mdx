...
<Figure caption="Visualization of policy learning in the Meta-World simulation environment. We run P<span style="font-size: 80%">ROGRESSOR</span> and several baselines on
six diverse tasks of various difficulties. We also run P<span style="font-size: 80%">ROGRESSOR</span> without online push-back as an ablation. We report the environment
...
the transparent area denotes standard deviation. P<span style="font-size: 80%">ROGRESSOR</span> demonstrates clear advantages in both metrics, especially at early stages of training">
